...
Template.blazeContent.events({
  "hidden.bs.collapse #event": function(event){
    $('#blazeContent').empty().html('Loading...');
  },
  "click .js-cancel": function (event) {
    var form = $(event.currentTarget).parents('form').data('ex-title');
    debugger;
